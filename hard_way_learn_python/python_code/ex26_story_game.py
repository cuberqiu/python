...
def death():
    quips = ["You did. You kinda suck at this.",
...
def central_corridor():
    print "The GOthons of Planet Percal #25 have invaded yor ship and destroyed"
    ...
    if action == "shoot!":
        ...
        print "Lbne zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf \
                nebhaq gur ubhfr."
